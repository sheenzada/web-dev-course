...
Letter.prototype.reset = function () {
    ...
    this.spawningTime =
        (opts.fireworkSpawnTime * Math.random()) | 0;
    ...
    if (this.phase === "firework") {
        ...
        if (!this.spawned) {
            ...
            var linearProportion =
                ...
                armonicProportion =
                Math.sin(linearProportion * TauQuarter),
